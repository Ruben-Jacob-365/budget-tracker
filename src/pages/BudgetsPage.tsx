...
export default function BudgetsPage() {
  ...
  function openEdit(b: Budget) { setEditTarget(b); setSheetOpen(true) }
  function handleSuccess() { setSheetOpen(false); reload() }
      ...
      <div className="space-y-4">
        ...
        {!loading && budgets.length > 0 && (
          <div className="grid grid-cols-3 gap-3">
            ...
            <TotalPill label="Spent"     value={fmt(totals.totalSpent)}  red={totals.totalSpent > totals.totalBudget} />
            <TotalPill label="Remaining" value={fmt(Math.abs(totals.remaining))} green={totals.remaining >= 0} red={totals.remaining < 0} />
          </div>
        )}

        {loading ? (
          <div className="flex justify-center py-12" role="status" aria-label="Loading budgets">
          ...
          <div className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 text-center">
            ...
            <p className="mt-3 font-semibold text-slate-700 dark:text-slate-300">No budgets for this month</p>
